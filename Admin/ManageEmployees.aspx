                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" 
                                    ...
                                    ToolTip="User Name is required." ValidationGroup="Wizard">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="PasswordRequired" runat="server" 
                                    ...
                                    ToolTip="Password is required." ValidationGroup="Wizard">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="ConfirmPasswordRequired" runat="server" 
                                    ...
                                    ToolTip="Confirm Password is required." ValidationGroup="Wizard">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="EmailRequired" runat="server" 
                                    ...
                                    ToolTip="E-mail is required." ValidationGroup="Wizard">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="QuestionRequired" runat="server" 
                                    ...
                                    ToolTip="Security question is required." ValidationGroup="Wizard">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="AnswerRequired" runat="server" 
                                    ...
                                    ToolTip="Security answer is required." ValidationGroup="Wizard">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" colspan="2">
                                <asp:CompareValidator ID="PasswordCompare" runat="server" 
                                    ...
                                    ValidationGroup="Wizard"></asp:CompareValidator>
                            </td>
                        </tr>
                        <tr>
